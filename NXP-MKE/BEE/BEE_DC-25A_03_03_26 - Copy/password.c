...
void PW_Validation(void){
										...
										if(reset==true){     //after restting the password enters the run_time
											sel_mode=RUN_TIME;
										}
										else{              //initially at factory leve saves password and make user select fact setting
